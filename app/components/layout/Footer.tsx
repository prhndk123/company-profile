      ...
      <div className="container-wide section-padding px-8 pt-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4 flex flex-col items-start ">
            <div className="flex flex-col items-center gap-2">
              ...
              <div>
                <p className="text-[10px] text-background/70 leading-tight">
                  Engine Plant #3 Karawang
                </p>
              </div>
            </div>
            <p className="text-sm text-background/70 leading-relaxed">
              Toyota Motor Manufacturing Indonesia - Engine Plant #3 is
              committed to delivering world-class engines with precision,
          ...
          <div className="">
            ...
            <ul className="space-y-3">
              <li className="flex justify-center items-center gap-3 text-sm text-background/70">
                ...
                />
                <span>
                  Kawasan Industri KIIC, Karawang, West Java, Indonesia 41361
                </span>
              </li>
          ...
          <div className="">
            ...
            <p className="text-sm text-background/70">
              Follow us for the latest updates on manufacturing excellence and
              innovation.
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-background/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-background/50">
            © {new Date().getFullYear()} Toyota Motor Manufacturing Indonesia.
            All rights reserved.
          </p>
