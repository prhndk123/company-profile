...
const engines = [
  {
    ...
    image:
      "https://www.toyota.co.id/app/sam/assets/manufacturing/d2b7167d37e9c5da8ec8d7225cac858f.png?v=1689583360?w=800&auto=format&fit=crop",
  },
  {
    name: "2NR Series",
    tagline: "More Performance Compact Efficiency",
    description:
    ...
    specs: [
      "Cylinder volume: 1496 cc",
      "Maximum power: 78 kW / 6000 rpm",
      "Maximum torque: 138 Nm / 4200 rpm",
      "Minimum fuel consumption idle: 0.1 g/sec @ 650 rpm",
      "Diameter x Stroke: 72.5 x 90.5 mm",
      "Oil capacity: 3.9 litre",
      "Fuel system: EFI (Electronic Fuel Injection)",
      "Fuel type: Gasoline",
      "Additional variant: NR-Kai (shared with Daihatsu vehicles)",
    ...
    image:
      "https://www.toyota.co.id/app/sam/assets/manufacturing/78e4cb8cc66aaa275211cba67652b777.png?v=1663659677?w=800&auto=format&fit=crop",
  },
  {
    name: "2NR-Hybrid",
    ...
    specs: [
      "Cylinder volume: 1496 cc",
      "Maximum power: 67 kW / 5,500 rpm",
      "Maximum torque: 121 Nm / 4,000–4,800 rpm",
      "Diameter x Stroke: 72.5 x 90.6 mm",
      "Oil capacity: 3.9 litre",
      "Fuel system: EFI (Electronic Fuel Injection) with Toyota Hybrid System",
      "Fuel type: Gasoline",
      "Additional variant: Hybrid engine (2NR-VEX)",
    ],
    features: [
        ...
        <div className="container-wide">
          ...
          >
            ...
            <p className="text-body">
              Each engine is crafted with meticulous attention to detail <br />
